...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "new_project20", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<new_project20Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "new_project20 API v1");
