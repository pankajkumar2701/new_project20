using new_project20.Models;
using new_project20.Data;
using new_project20.Filter;
using new_project20.Entities;
using new_project20.Logger;
...
namespace new_project20.Services
{
    /// <summary>
    ...
    {
        private readonly new_project20Context _dbContext;
        ...
        public RoleEntitlementService(new_project20Context dbContext, IFieldMapperService mapper)
        {
